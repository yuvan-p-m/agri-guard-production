...
export const cropDiseases: DiseaseDiagnosis[] = [
  {
    ...
    cropName: {
      ...
      "te": "నిమ్మ / నారింజ / బత్తాయి (Citrus)",
      "kn": "ಕಿತ್ತಳೆ / ನಿಂಬೆ / ಮೋಸಂಬಿ (Citrus)",
      "ml": "നാരങ്ങ / ഓറഞ്ച് / മുസമ്പി",
      "mr": "संत्रा / मोसंबी / लिंबू (Citrus)",
      "bn": "লেবু / কমলালেবু / বাতাবি লেবু",
      "gu": "લીંબુ / નારંગી / મોસંબી (Citrus)",
      "pa": "ਸੰਤਰਾ / ਨਿੰਬੂ / ਮੌਸੰਮੀ",
      "ur": "مالٹا / لیموں / کینو",
      "or": "ଲେମ୍ବୁ / କମଳା / ମୌସୁମ୍ବୀ",
      "as": "টেঙা / নেমু / কমলা",
      "ne": "सुन्तला / कागती / मौसम",
      "si": "දෙහි / දොඩම් / නාරං",
      "ar": "الحمضيات (برتقال / ليمون)",
      "fr": "Agrumes (Orange / Citron)",
      "es": "Cítricos (Naranja / Limón)",
      "pt": "Citros (Laranja / Limão)",
      "de": "Zitrusfrüchte (Orange / Zitrone)",
      "it": "Agrumi (Arancia / Limone)",
      "ru": "Цитрусовые (Апельсин / Лимон)",
      "ja": "柑橘類 (オレンジ / レモン)",
      "ko": "감귤류 (오렌지 / 레몬)",
      "zh": "柑橘类 (甜橙 / 柠檬)"
},
    diseaseName: {
      ...
      "te": "సిట్రస్ కాంకర్ బాక్టీరియల్ తెగులు (ప్రారంభ దశ)",
      "kn": "ಸಿಟ್ರಸ್ ಕ್ಯಾಂಕರ್ ಬ್ಯಾಕ್ಟೀರಿಯಾ ರೋಗ (ಆರಂಭಿಕ ಹಂತ)",
      "ml": "സിട്രസ് കാങ്കർ ബാക്ടീരിയൽ രോഗം (പ്രാരംഭ ഘട്ടം)",
      "mr": "लिंबूवर्गीय कॅन्कर जिवाणू रोग (प्रारंभिक टप्पा)",
      "bn": "লেবুর ব্যাকটেরিয়াজনিত ক্যাঙ্কার রোগ (প্রাথমিক পর্যায়)",
      "gu": "લીંબુ કેન્કર જીવાણુજન્ય રોગ (પ્રારંભિક તબક્કો)",
      "pa": "ਨਿੰਬੂ ਕੈਂਕਰ ਬੈਕਟੀਰੀਆ ਰੋਗ (ਮੁੱਢਲਾ ਪੜਾਅ)",
      "ur": "سٹرس کینکر بیکٹیریل بیماری (ابتدائی مرحلہ)",
      "or": "ଲେମ୍ବୁ କ୍ୟାଙ୍କର ଜୀବାଣୁ ରୋଗ (ପ୍ରାରମ୍ଭିକ ପର୍ଯ୍ୟାୟ)",
      "as": "টেঙাৰ কেংকাৰ বেক্টেৰিয়াজনিত ৰোগ (প্ৰাৰম্ভিক পৰ্যায়)",
      "ne": "कागती क्याङ्कर ब्याक्टेरियल रोग (प्रारम्भिक चरण)",
      "si": "දෙහි පැපොල බැක්ටීරියා රෝගය (මුල් අවධිය)",
      "ar": "تقرح الحمضيات البكتيري (المرحلة المبكرة)",
      "fr": "Chancre bactérien des agrumes (Stade précoce)",
      "es": "Cancro bacteriano de los cítricos (Etapa temprana)",
      "pt": "Cancro cítrico bacteriano (Fase inicial)",
      "de": "Bakterieller Zitruskrebs (Frühstadium)",
      "it": "Cancro batterico degli agrumi (Fase iniziale)",
      "ru": "Бактериальный рак цитрусовых (Ранняя стадия)",
      "ja": "カンキツかいよう病 (初期段階)",
      "ko": "감귤 궤양병 (초기 단계)",
      "zh": "柑橘溃疡病 (早期)"
},
  ...
  },
  {
    ...
    cropName: {
      ...
      "pa": "ਟਮਾਟਰ (Tomato)",
      "ur": "ٹماٹر (Tomato)",
      "or": "ବିଲାତି ବାଇଗଣ (Tomato)",
      "as": "বিলাহী (Tomato)",
      "ne": "गोलभेंडा (Tomato)",
      "si": "තක්කාලි (Tomato)",
      "ar": "طماطم (Tomato)",
      "fr": "Tomate (Solanum lycopersicum)",
      "es": "Tomate (Solanum lycopersicum)",
      "pt": "Tomate (Solanum lycopersicum)",
      "de": "Tomate (Solanum lycopersicum)",
      "it": "Pomodoro (Solanum lycopersicum)",
      "ru": "Томат (Solanum lycopersicum)",
      "ja": "トマト (Solanum lycopersicum)",
      "ko": "토마토 (Solanum lycopersicum)",
      "zh": "番茄 (Solanum lycopersicum)"
},
    diseaseName: {
      "en": "Tomato Late Blight (Phytophthora infestans)",
      "hi": "टमाटर पछेती झुलसा रोग (Late Blight)",
      "ta": "தக்காளி பின்கால கருகல் நோய் (Late Blight)",
      "te": "టమోటా ఆలస్యపు తెగులు (Late Blight)",
      "kn": "ಟೊಮೆಟೊ ತಡವಾದ ಕರಗು ರೋಗ (Late Blight)",
      "ml": "തക്കാളി ലേറ്റ് ബ്ലൈറ്റ് രോഗം (Late Blight)",
      "mr": "टोमॅटो उशिरा येणारा करपा (Late Blight)",
      "bn": "টমেটোর নাবী ধসা রোগ (Late Blight)",
      "gu": "ટામેટાં પાછોતરો સુકારો (Late Blight)",
      "pa": "ਟਮਾਟਰ ਪਛੇਤਾ ਝੁਲਸਾ ਰੋਗ (Late Blight)",
      "ur": "ٹماٹر لیٹ بلائٹ (Late Blight)",
      "or": "ଟମାଟୋ ପଛୁଆ ପତ୍ରପୋଡ଼ା ରୋଗ (Late Blight)",
      "as": "বিলাহীৰ পানী ব্লাইট ৰোগ (Late Blight)",
      "ne": "गोलभेंडा पछेती डढुवा (Late Blight)",
      "si": "තක්කාලි පසු අංගමාරය (Late Blight)",
      "ar": "لفحة الطماطم المتأخرة (Late Blight)",
      "fr": "Mildiou de la tomate (Late Blight)",
      "es": "Tizón tardío del tomate (Late Blight)",
      "pt": "Requeima do tomateiro (Late Blight)",
      "de": "Kraut- und Braunfäule der Tomate (Late Blight)",
      "it": "Peronospora del pomodoro (Late Blight)",
      "ru": "Фитофтороз томатов (Late Blight)",
      "ja": "トマト疫病 (Late Blight)",
      "ko": "토마토 역병 (Late Blight)",
      "zh": "番茄晚疫病 (Late Blight)"
},
  ...
  },
  {
    ...
    cropName: {
      ...
      "kn": "ಭತ್ತ / ಅಕ್ಕಿ (Paddy / Rice)",
      "ml": "നെല്ല് / അരി (Paddy / Rice)",
      "mr": "भात / धान (Paddy / Rice)",
      "bn": "ধান / চাল (Paddy / Rice)",
      "gu": "ડાંગર / ચોખા (Paddy / Rice)",
      "pa": "ਝੋਨਾ / ਚੌਲ (Paddy / Rice)",
      "ur": "دھان / چاول (Paddy / Rice)",
      "or": "ଧାନ (Paddy / Rice)",
      "as": "ধান / চাউল (Paddy / Rice)",
      "ne": "धान / चामल (Paddy / Rice)",
      "si": "වී / සහල් (Paddy / Rice)",
      "ar": "الأرز (Paddy / Rice)",
      "fr": "Riz / Paddy (Oryza sativa)",
      "es": "Arroz / Paddy (Oryza sativa)",
      "pt": "Arroz / Paddy (Oryza sativa)",
      "de": "Reis (Oryza sativa)",
      "it": "Riso (Oryza sativa)",
      "ru": "Рис (Oryza sativa)",
      "ja": "イネ / 米 (Oryza sativa)",
      "ko": "벼 / 쌀 (Oryza sativa)",
      "zh": "水稻 / 稻谷 (Oryza sativa)"
},
    diseaseName: {
      "en": "Rice Brown Spot (Bipolaris oryzae)",
      "hi": "धान का भूरा धब्बा रोग (Brown Spot)",
      "ta": "நெல் பழுப்பு புள்ளி நோய் (Brown Spot)",
      "te": "వరి గోధుమ రంగు మచ్చల తెగులు (Brown Spot)",
      "kn": "ಭತ್ತದ ಕಂದು ಕಲೆ ರೋಗ (Brown Spot)",
      "ml": "നെല്ലിലെ തവിട്ടുപുള്ളി രോഗം (Brown Spot)",
      "mr": "भातावरील तांबडे ठिपके (Brown Spot)",
      "bn": "ধানের বাদামী দাগ রোগ (Brown Spot)",
      "gu": "ડાંગરનો બદામી ટપકાંનો રોગ (Brown Spot)",
      "pa": "ਝੋਨੇ ਦਾ ਭੂਰਾ ਧੱਬਾ ਰੋਗ (Brown Spot)",
      "ur": "دھان کا بھورا دھبہ (Brown Spot)",
      "or": "ଧାନର ବାଦାମୀ ଦାଗ ରୋଗ (Brown Spot)",
      "as": "ধানৰ মুগা দাগ ৰোগ (Brown Spot)",
      "ne": "धानको खैरो थोپ्ले रोग (Brown Spot)",
      "si": "වී දුඹුරු ලප රෝගය (Brown Spot)",
      "ar": "التبقع البني في الأرز (Brown Spot)",
      "fr": "Helminthosporiose du riz (Brown Spot)",
      "es": "Mancha marrón del arroz (Brown Spot)",
      "pt": "Mancha-parda do arroz (Brown Spot)",
      "de": "Braunfleckigkeit des Reises (Brown Spot)",
      "it": "Elmintosporiosi del riso (Brown Spot)",
      "ru": "Бурая пятнистость риса (Brown Spot)",
      "ja": "イネごま葉枯病 (Brown Spot)",
      "ko": "벼 깨씨무늬병 (Brown Spot)",
      "zh": "水稻胡麻叶斑病 (Brown Spot)"
},
  ...
  },
  {
    ...
    cropId: 'chilli',
    cropName: {
      "en": "Chilli / Pepper (Capsicum annuum)",
      ...
      "ne": "खुर्सानी (Chilli)",
      "si": "මිරිස් (Chilli)",
      "ar": "الفلفل الحار (Chilli)",
      "fr": "Piment / Poivron (Capsicum annuum)",
      "es": "Chile / Pimiento (Capsicum annuum)",
      "pt": "Pimenta / Pimentão (Capsicum annuum)",
      "de": "Chili / Paprika (Capsicum annuum)",
      "it": "Peperoncino (Capsicum annuum)",
      "ru": "Перец чили (Capsicum annuum)",
      "ja": "トウガラシ (Capsicum annuum)",
      "ko": "고추 (Capsicum annuum)",
      "zh": "辣椒 (Capsicum annuum)"
},
    diseaseName: {
      "en": "Chilli Leaf Curl Virus (Begomovirus)",
      "hi": "मिर्च पत्ती मरोड़ विषाणु (Leaf Curl)",
      "ta": "மிளகாய் இலை சுருள் வைரஸ் (Leaf Curl)",
      "te": "మిరప ఆకు ముడుత వైరస్ తెగులు (Leaf Curl)",
      "kn": "ಮೆಣಸಿನಕಾಯಿ ಎಲೆ ಸುರುಳಿ ವೈರಸ್ (Leaf Curl)",
      "ml": "മുളക് ഇലച്ചുരുൾ വൈറസ് (Leaf Curl)",
      "mr": "मिरची पर्णगुच्छ विषाणू (Leaf Curl)",
      "bn": "মরিচের পাতা কোঁকড়ানো ভাইরাস (Leaf Curl)",
      "gu": "મરચી પાન કુકડાઈ વાયરસ (Leaf Curl)",
      "pa": "ਮਿਰਚ ਪੱਤਾ ਮਰੋੜ ਵਿਸ਼ਾਣੂ (Leaf Curl)",
      "ur": "مرچ پتا مروڑ وائرس (Leaf Curl)",
      "or": "ଲଙ୍କା ପତ୍ର କୁଞ୍ଚନ ଭୂତାଣୁ (Leaf Curl)",
      "as": "জলকীয়াৰ পাত কেঁকোৰা ভাইৰাছ (Leaf Curl)",
      "ne": "खुर्सानीको पात खुम्चिने भाइरस (Leaf Curl)",
      "si": "මිරිස් කොළ කොඩවීම් වෛරසය (Leaf Curl)",
      "ar": "فيروس تجعد أوراق الفلفل (Leaf Curl)",
      "fr": "Virus de l'enroulement des feuilles de piment",
      "es": "Virus del rizado de la hoja del chile",
      "pt": "Vírus do enrolamento da folha da pimenta",
      "de": "Chili-Blattrollvirus (Leaf Curl)",
      "it": "Virus dell'accartocciamento fogliare del peperoncino",
      "ru": "Вирус курчавости листьев перца",
      "ja": "トウガラシ葉巻ウイルス (Leaf Curl)",
      "ko": "고추 잎말림 바이러스 (Leaf Curl)",
      "zh": "辣椒曲叶病毒 (Leaf Curl)"
},
  ...
  },
  {
    ...
    cropId: 'healthy',
    cropName: {
      "en": "Healthy Crop Baseline (Foliar Tissue)",
      "hi": "स्वस्थ फसल मानक (पत्ती ऊतक)",
      "ta": "ஆரோக்கியமான பயிர் அடிப்படை (இலை)",
      "te": "ఆరోగ్యకరమైన పంట ప్రమాణం (ఆకు కణజాలం)",
      "kn": "ಆರೋಗ್ಯಕರ ಬೆಳೆ ಮಾನದಂಡ (ಎಲೆ ಅಂಗಾಂಶ)",
      "ml": "ആരോഗ്യമുള്ള വിള മാതൃക (ഇല)",
      "mr": "निरोगी पीक प्रमाणक (पानांचे ऊती)",
      "bn": "সুস্থ ফসলের মানদণ্ড (পাতার টিস্যু)",
      "gu": "તંદુરસ્ત પાક આધારરેખા (પર્ણ પેશી)",
      "pa": "ਸਿਹਤਮੰਦ ਫਸਲ ਮਿਆਰ (ਪੱਤਾ ਟਿਸ਼ੂ)",
      "ur": "صحت مند فصل کا معیار",
      "or": "ସୁସ୍ଥ ଫସଲ ମାନଦଣ୍ଡ",
      "as": "সুস্থ শস্য মানদণ্ড (পাতৰ কলা)",
      "ne": "स्वस्थ बाली मापदण्ड",
      "si": "නිරෝගී බෝග පදනම",
      "ar": "معيار المحصول السليم",
      "fr": "Culture saine de référence (Tissu foliaire)",
      "es": "Cultivo sano de referencia (Tejido foliar)",
      "pt": "Cultura saudável de referência (Tecido foliar)",
      "de": "Gesunde Referenzpflanze (Blattgewebe)",
      "it": "Coltura sana di riferimento (Tessuto fogliare)",
      "ru": "Здоровая эталонная культура (Ткань листа)",
      "ja": "健全な基準作物 (葉組織)",
      "ko": "건강한 표준 작물 (잎 조직)",
      "zh": "健康基准作物 (叶片组织)"
},
    diseaseName: {
      ...
      "hi": "स्वस्थ पौधा (कोई रोग नहीं मिला)",
      "ta": "ஆரோக்கியமான தாவரம் (நோய் ஏதுமில்லை)",
      "te": "ఆరోగ్యకరమైన మొక్క (ఎటువంటి తెగులు లేదు)",
      "kn": "ಆರೋಗ್ಯಕರ ಸಸ್ಯ (ಯಾವುದೇ ರೋಗವಿಲ್ಲ)",
      "ml": "ആരോഗ്യമുള്ള ചെടി (രോഗങ്ങളൊന്നുമില്ല)",
      "mr": "निरोगी वनस्पती (कोणताही रोग नाही)",
      "bn": "সুস্থ উদ্ভিদ (কোনো রোগ পাওয়া যায়নি)",
      "gu": "તંદુરસ્ત છોડ (કોઈ રોગ નથી)",
      "pa": "ਸਿਹਤਮੰਦ ਬੂਟਾ (ਕੋਈ ਬਿਮਾਰੀ ਨਹੀਂ ਮਿਲੀ)",
      "ur": "صحت مند پودا (کوئی بیماری نہیں)",
      "or": "ସୁସ୍ଥ ଗଛ (କୌଣସି ରୋଗ ଚିହ୍ନଟ ହୋଇନାହିଁ)",
      "as": "সুস্থ উদ্ভিদ (কোনো ৰোগ নাই)",
      "ne": "स्वस्थ बिरुवा (कुनै रोग देखिएन)",
      "si": "නිරෝගී ශාකය (රෝග හඳුනාගෙන නොමැත)",
      "ar": "نبات سليم (لم يتم اكتشاف أي مرض)",
      "fr": "Plante saine (Aucune maladie détectée)",
      "es": "Planta sana (No se detectaron enfermedades)",
      "pt": "Planta saudável (Nenhuma doença detectada)",
      "de": "Gesunde Pflanze (Keine Krankheit erkannt)",
      "it": "Pianta sana (Nessuna malattia rilevata)",
      "ru": "Здоровое растение (Болезни не обнаружены)",
      "ja": "健全な植物 (病気は検出されませんでした)",
      "ko": "건강한 식물 (질병 감지되지 않음)",
      "zh": "健康植株 (未检测到病害)"
},
