      ...
      <div className="bg-white/95 backdrop-blur-md rounded-3xl p-5 sm:p-7 shadow-xl border border-agri-200/80">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <h2 className="text-xl sm:text-2xl font-black text-slate-900 tracking-tight">{t('fieldData.soilHeading')}</h2>
            <p className="text-xs sm:text-sm text-agri-900 font-semibold mt-1.5 max-w-2xl leading-relaxed bg-agri-50/80 p-2.5 rounded-xl border border-agri-200/60">
              🌱 {t('iot.quote', 'Leverages historical sensor data to recommend suitable crops and deliver timely farming insights')}
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2.5 self-start md:self-auto">
            {!hardwareState.isConnected && (
              ...
              >
                ...
                <span>{hardwareState.deviceId || t('modals.hardwarePairTitle', 'Pair Hardware')}</span>
              </button>
            )}
            ...
            >
              ...
              <span>{isRefreshing ? t('iot.syncing', 'Syncing...') : t('iot.syncNow', 'Sync Now')}</span>
            </button>
          </div>
        </div>
              ...
              <div className="bg-white/95 backdrop-blur-md rounded-3xl p-5 shadow-lg border border-slate-200 flex flex-col justify-between space-y-3 hover:border-agri-400 transition-all">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <h3 className="text-xs font-black uppercase tracking-wider text-slate-700">{t('sensor.ph', 'Soil pH')}</h3>
                      <p className="text-[10px] text-slate-400 font-medium">{t('sensor.phSub', 'Acidity / Alkalinity')}</p>
                    </div>
                  </div>
                ...
                <div className="p-3 bg-slate-50 rounded-2xl border border-slate-200/80">
                  ...
                  <span className="text-[10px] text-slate-500 font-medium block mt-0.5">{t('sensor.optimalRange', 'Optimal Range')}: 6.0 – 7.5</span>
                </div>
              ...
              <div className="bg-white/95 backdrop-blur-md rounded-3xl p-5 shadow-lg border border-slate-200 flex flex-col justify-between space-y-3 hover:border-agri-400 transition-all">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <h3 className="text-xs font-black uppercase tracking-wider text-slate-700">{t('sensor.humidity', 'Air Humidity')}</h3>
                      <p className="text-[10px] text-slate-400 font-medium">{t('sensor.humiditySub', 'Ambient Relative Humidity')}</p>
                    </div>
                  </div>
                ...
                <div className="p-3 bg-slate-50 rounded-2xl border border-slate-200/80">
                  ...
                  <span className="text-[10px] text-slate-500 font-medium block mt-0.5">{t('sensor.optimalRange', 'Optimal Range')}: 40% – 70%</span>
                </div>
              ...
              <div className="bg-white/95 backdrop-blur-md rounded-3xl p-5 shadow-lg border border-slate-200 flex flex-col justify-between space-y-3 hover:border-agri-400 transition-all">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <h3 className="text-xs font-black uppercase tracking-wider text-slate-700">{t('sensor.temperature', 'Temperature')}</h3>
                      <p className="text-[10px] text-slate-400 font-medium">{t('sensor.temperatureSub', 'Ambient Canopy Temp')}</p>
                    </div>
                  </div>
                ...
                <div className="p-3 bg-slate-50 rounded-2xl border border-slate-200/80">
                  ...
                  <span className="text-[10px] text-slate-500 font-medium block mt-0.5">{t('sensor.optimalRange', 'Optimal Range')}: 18°C – 30°C</span>
                </div>
              ...
              <div className="bg-white/95 backdrop-blur-md rounded-3xl p-5 shadow-lg border border-slate-200 flex flex-col justify-between space-y-3 hover:border-agri-400 transition-all">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <h3 className="text-xs font-black uppercase tracking-wider text-slate-700">{t('sensor.moisture', 'Soil Moisture')}</h3>
                      <p className="text-[10px] text-slate-400 font-medium">{t('sensor.moistureSub', 'Volumetric Water Content')}</p>
                    </div>
                  </div>
                ...
                <div className="p-3 bg-slate-50 rounded-2xl border border-slate-200/80">
                  ...
                  <span className="text-[10px] text-slate-500 font-medium block mt-0.5">{t('sensor.optimalRange', 'Optimal Range')}: 40% – 60%</span>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              {readings.nitrogen && (
                <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200/90 space-y-2">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-black text-slate-800">{t('sensor.nitrogen', 'Nitrogen (N)')}</span>
                  ...
                  <p className="text-[10px] text-slate-400 font-medium pt-1 border-t border-slate-200">
                    {t('sensor.standardRange', 'Standard range')}: 80 – 200 mg/kg
                  </p>
                </div>
              )}
              ...
              {readings.phosphorous && (
                <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200/90 space-y-2">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-black text-slate-800">{t('sensor.phosphorous', 'Phosphorus (P)')}</span>
                  ...
                  <p className="text-[10px] text-slate-400 font-medium pt-1 border-t border-slate-200">
                    {t('sensor.standardRange', 'Standard range')}: 40 – 100 mg/kg
                  </p>
                </div>
              )}
              ...
              {readings.potassium && (
                <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200/90 space-y-2">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-black text-slate-800">{t('sensor.potassium', 'Potassium (K)')}</span>
                  ...
                  <p className="text-[10px] text-slate-400 font-medium pt-1 border-t border-slate-200">
                    {t('sensor.standardRange', 'Standard range')}: 100 – 250 mg/kg
                  </p>
                </div>
              )}
            </div>
              ...
              <div className="bg-white/95 backdrop-blur-md rounded-3xl p-5 shadow-lg border border-slate-200 space-y-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <h3 className="text-xs font-black uppercase tracking-wider text-slate-700">{t('sensor.ec', 'Conductivity (EC)')}</h3>
                      <p className="text-[10px] text-slate-400 font-medium">{t('sensor.ecSub', 'Salinity & Total Dissolved Solids')}</p>
                    </div>
                  </div>
                ...
                <div className="p-3 bg-slate-50 rounded-2xl border border-slate-200/80">
                  ...
                  <span className="text-[10px] text-slate-500 font-medium block mt-0.5">{t('sensor.optimalRange', 'Optimal')}: 50 – 200 µS/cm</span>
                </div>
              ...
              <div className="bg-white/95 backdrop-blur-md rounded-3xl p-5 shadow-lg border border-slate-200 space-y-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <h3 className="text-xs font-black uppercase tracking-wider text-slate-700">{t('sensor.rain', 'Rain Sensor')}</h3>
                      <p className="text-[10px] text-slate-400 font-medium">{t('sensor.rainSub', 'Precipitation Detector')}</p>
                    </div>
                  </div>
                ...
                <div className="p-3 bg-slate-50 rounded-2xl border border-slate-200/80">
                  ...
                  <span className="text-[10px] text-slate-500 font-medium block mt-0.5">{t('fieldData.liveWeatherSensor', 'Live Weather Sensor')}</span>
                </div>
              ...
              <div className="bg-white/95 backdrop-blur-md rounded-3xl p-5 shadow-lg border border-slate-200 space-y-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <h3 className="text-xs font-black uppercase tracking-wider text-slate-700">{t('sensor.pump', 'Irrigation Pump')}</h3>
                      <p className="text-[10px] text-slate-400 font-medium">{t('sensor.pumpSub', 'Relay Switch State')}</p>
                    </div>
                  </div>
                  <span
          ...
          <div className="flex items-center justify-center pt-2 pb-1">
            <div className="inline-flex items-center justify-center gap-2.5 px-4 py-2.5 rounded-2xl bg-emerald-50 dark:bg-emerald-950/60 border-2 border-emerald-400 dark:border-emerald-600 text-emerald-950 dark:text-emerald-100 shadow-sm max-w-3xl text-center">
              ...
              <span className="text-xs sm:text-sm font-bold tracking-tight leading-snug">
                {t('iot.disconnectedNotice', 'When hardware is disconnected, displayed data reflects the latest available sensor readings.')}
              </span>
            </div>
          </div>
        </>
