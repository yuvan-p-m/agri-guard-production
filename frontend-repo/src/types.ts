...
export interface DiseaseDiagnosis {
  id: string;
  cropId: string;
  cropName: { en: string; hi?: string; ta?: string; [key: string]: string | undefined };
  diseaseName: { en: string; hi?: string; ta?: string; [key: string]: string | undefined };
  scientificName: string;
  pathogenType: 'Fungus' | 'Bacterium' | 'Virus' | 'Pest' | 'Nutrient Deficiency';
  stage: 'Early Stage (Inception)' | 'Moderate Progression' | 'Severe Outbreak' | string;
  confidence: number;
  incubationPeriod: string;
  spreadRiskRate: number; // e.g. 45% crop loss if untreated in 7 days
  earlyWarningAlert: { en: string; hi?: string; ta?: string; [key: string]: string | undefined };
  symptoms: { en: string[]; hi?: string[]; ta?: string[]; [key: string]: string[] | undefined };
  visualFeatures: string[];
  organicProtocol: {
    overview: { en: string; hi?: string; ta?: string; [key: string]: string | undefined };
    remedies: RemedyItem[];
  };
  chemicalProtocol: {
    overview: { en: string; hi?: string; ta?: string; [key: string]: string | undefined };
  ...
  preventativeTips: { en: string[]; hi?: string[]; ta?: string[]; [key: string]: string[] | undefined };
